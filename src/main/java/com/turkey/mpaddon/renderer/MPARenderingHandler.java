package com.turkey.mpaddon.renderer;
...
import com.turkey.mpaddon.blocks.ForeverFire;
import com.turkey.mpaddon.blocks.MPABlocks;

import cpw.mods.fml.client.registry.ISimpleBlockRenderingHandler;

public class MPARenderingHandler implements ISimpleBlockRenderingHandler
{
	...
	{
		if(modelId == MPABlocks.FOREVER_FIRE_ID)
			this.renderBlockForeverFire(world, block, x, y, z, renderer);
		return false;
	}
    ...
    public boolean renderBlockForeverFire(IBlockAccess world, Block block, int x, int y, int z, RenderBlocks renderer)
    {
    	Tessellator tessellator = Tessellator.instance;
        IIcon iicon = ((ForeverFire)block).getFireIcon(0);
        IIcon iicon1 = ((ForeverFire) block).getFireIcon(1);
        IIcon iicon2 = iicon;
